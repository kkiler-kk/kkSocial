...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        String[] strings = {"/user/login","/user/send-email","/user/*","/user/exist-name/*","/user/register/*","/user/exist-email","/hello","/news/get-top/**","/comment/news-id/*","/**","/swagger-resources/**", "/webjars/**", "/v2/**", "/swagger-ui.html/**"};
